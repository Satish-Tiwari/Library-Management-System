...
import './UpdateUserMgt.css'; // import custom CSS file
import createMaintenanceContext from '../../context/maintenance/createMaintenanceContext';

function UpdateUserMgt() {
   
  const {updateUserMgt} = useContext(createMaintenanceContext);
  ...
  const handleSubmit = async (event) => {
    ...
    console.log('Form submitted:', isNewUser, name, isActive, isAdmin);
    
    const result = await updateUserMgt(isNewUser, name, isActive, isAdmin, userMgtNo);
      console.log(result);
    if(!result.success)
    {
      alert("Invalid....");
      ...
      alert("User management updated successfull");
    }
  };
